...
namespace SchoolManagmentApp.MVC.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public CoursesController(SchoolManagmentDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Courses != null ? 
                          ...
                          Problem("Entity set 'SchoolManagmentDbContext.Courses'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SchoolManagmentDbContext.Courses'  is null.");
            }
            var course = await _context.Courses.FindAsync(id);
            if (course != null)
            {
