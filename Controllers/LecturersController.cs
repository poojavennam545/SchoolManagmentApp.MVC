...
namespace SchoolManagmentApp.MVC.Controllers
{
    public class LecturersController : Controller
    {
        ...
        public LecturersController(SchoolManagmentDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Lecturers != null ? 
                          ...
                          Problem("Entity set 'SchoolManagmentDbContext.Lecturers'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SchoolManagmentDbContext.Lecturers'  is null.");
            }
            var lecturer = await _context.Lecturers.FindAsync(id);
            if (lecturer != null)
            {
